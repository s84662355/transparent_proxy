...
import (
	...
	"transparent/gvisor.dev/gvisor/pkg/log"
)
...
const (
	...
	transparentMwaitParams        cpuidFunction = 0x5               // Returns information about transparent/mwait instructions.
	...
	intelPMCInfo                  cpuidFunction = 0xa               // Returns information about performance transparenting features. Intel only.
